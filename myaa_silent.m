function [varargout] = myaa_silent(varargin)
...
if ~strcmp(self.figmode,'lazyupdate');
    tempfile = ['myaa_temp_screendump_' num2str(randi(1e9,1)) num2str(randi(1e9,1)) num2str(randi(1e9,1)) '.png'];
    self.source_fig = gcf;
...
%JH: renormalize raw_lowres
raw_lowres = raw_lowres./max(raw_lowres(:));
...
if strcmp(self.figmode,'figure');
    ...
    self.myaa_figure = figure('visible', 'off');
